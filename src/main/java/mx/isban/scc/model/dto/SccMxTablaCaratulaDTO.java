...
/**
 * DTO para carátula de crédito
 * 
 * @author José Luis Garcia
 * 
 *
 */
public class SccMxTablaCaratulaDTO extends SccMxTablaCaratulaPadreDTO implements java.io.Serializable {

	/**
	 * identificador para serializar la clase SccMxTablaCaratulaInDTO
	 */
	...
	/**
	 * propiedad dia de pago
	 */
	private String diaPago;
	
	/**
	 * propiedad comision por apertura en letra
	 */
	private String aperturaL;
	
	/**
	 * propiedad pago tardio
	 */
	private Double pagoTardio;
	
	/**
	 * propiedad pago tardio en letra
	 */
	private String tardioL;
	...
	/**
	 * 
	 * @return comision por apertura en letra
	 */
	public String getAperturaL() {
		return aperturaL;
	}

	/**
	 * 
	 * @param comision por apertura en letra
	 */
	public void setAperturaL(String aperturaL) {
		this.aperturaL = aperturaL;
	}
	...
	/**
	 * 
	 * @return pago tardio en letra
	 */
	public String getTardioL() {
		return tardioL;
	}

	/**
	 * 
	 * @param pago tardio en letra
	 */
	public void setTardioL(String tardioL) {
		this.tardioL = tardioL;
	}
